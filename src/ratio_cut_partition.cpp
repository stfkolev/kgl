...
#include <KGL/debug.h>
#include <KGL/dfs.h>
#include <KGL/ratio_cut_partition.h>
...
{
    KGL_debug::init_debug();
    KGL_debug::os() << endl << "bucketB:" << endl;
    for (int i = 0; i <= 2 * max_vertex_degree * max_edge_weight; i++)
    {
	KGL_debug::os() << range_down(i) << ": ";
