...
//
//==========================================================================
// $Id: pq_node.h,v 1.15 2019/05/07 11:48:26 raitner Exp $
...
protected:
     ...
     */
    KGL_EXTERN friend ostream& operator<<(ostream&, const pq_tree&);
};
 ...
 * @internal
 */
class KGL_EXTERN p_node : public pq_node 
{
private:
    /**
     * @internal
 ...
 * @internal
 */
class KGL_EXTERN q_node : public pq_node 
{
private:
    /**
     * @internal
 ...
 * @internal
 */
class KGL_EXTERN pq_leaf : public pq_node 
{
public:
    /**
     * @internal
 ...
 * @internal
 */
class KGL_EXTERN direction_indicator : public pq_node 
{
private:
    /**
     * @internal
