...
//
//==========================================================================
// $Id: node.h,v 1.20 2019/11/27 13:36:56 raitner Exp $
...
private:
    ...
    KGL_EXTERN friend bool operator==(node, node);
    KGL_EXTERN friend bool operator!=(node, node);
    KGL_EXTERN friend bool operator<(node, node);
    KGL_EXTERN friend ostream& operator<< (ostream& os, const node& n);
};
 ...
 */
class KGL_EXTERN node::adj_edges_iterator : public bi_iter_edge
{
public:
 ...
 */
class KGL_EXTERN node::inout_edges_iterator : public bi_iter_edge
{
public:
 ...
 */
class KGL_EXTERN node::adj_nodes_iterator : public bi_iter_node
{
public:
...
// #define forall_adj_nodes(v,w)	KGL_FORALL(v,w,node::adj_nodes_iterator,adj_nodes_)
#define forall_out_edges(e,v)	KGL_FORALL(e,v,node::out_edges_iterator,out_edges_)
#define forall_in_edges(e,v)	KGL_FORALL(e,v,node::in_edges_iterator,in_edges_)
#define forall_inout_edges(e,v)	KGL_FORALL(e,v,node::inout_edges_iterator,inout_edges_)
#define forall_adj_edges(e,v)	KGL_FORALL(e,v,node::adj_edges_iterator,adj_edges_)
