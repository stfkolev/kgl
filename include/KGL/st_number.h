...
//
//==========================================================================
// $Id: st_number.h,v 1.17 2019/12/20 08:26:08 chris Exp $

#ifndef KGL_ST_NUMBER_H
#define KGL_ST_NUMBER_H
 ...
 *   number 1.
 */
class KGL_EXTERN st_number : public algorithm 
{
public:
    /**
     ...
     * @note As for all algorithms in KGL_, #check must be called, because it
     * might do some initialization.
     *
     * @param G graph
     *
     * @retval algorithm::KGL_OK iff st-number algorithm may be applied
     *
     * @sa algorithm::check
     */
    int check(graph& G);
     ...
     * @param G graph
     *
     * @return algorithm::KGL_OK iff @p G could be correctly st-numbered
     *
     * @sa algorithm::run
     */
    int run(graph& G);
