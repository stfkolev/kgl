...
//
//==========================================================================
// $Id: planarity.h,v 1.22 2019/05/07 18:17:08 chris Exp $
...
#include <KGL/embedding.h>
#include <KGL/biconnectivity.h>
#include <KGL/pq_node.h>

__KGL_BEGIN_NAMESPACE

/**
 * $Date: 2019/05/07 18:17:08 $ 
 * $Revision: 1.22 $
 * 
 ...
 */
class KGL_EXTERN planarity : public algorithm 
{
public:
    /**
     ...
     * 
     * This should return always @c KGL_OK. There aren't any
     ...
     *
     * @retval KGL_OK if %planarity test can be applied
     * @retval KGL_ERROR if not
     *
     * @sa algorithm#check
     */
    int check(graph& G);
     ...
     * 
     * This should return always @c KGL_OK. The return value only
     ...
     * @param G arbitrary %graph
     *
     * @retval KGL_OK if %planarity test was sucessfully applied 
     * @retval KGL_ERROR if not
     *
     * @sa algorithm::run
     */
